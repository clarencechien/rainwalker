...
- **未來式（僅當四週後實驗進 fusion 才會發生）**：14:00/14:10 只有 OM 有訊號→若 OM 勝出，這兩輪可能升為「可能性高／等一下會下」；14:20 永和（本站乾、nb=3、寬 QPF 1.9）→若鄰站/寬 QPF 進 gating，會在雨到永和**之前**出現「鄰區雨勢逼近」級提示。這是兩實驗要買的東西，屆時人工拍板。
